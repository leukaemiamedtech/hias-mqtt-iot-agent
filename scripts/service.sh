...
printf -- 'This script will install the HIAS MQTT IoT Agent service on HIAS Core.\n';

read -p "Proceed (y/n)? " proceed
if [ "$proceed" = "Y" -o "$proceed" = "y" ]; then

        printf -- 'Installing HIAS MQTT IoT Agent service.\n';
        ...
        echo "ExecStart=/home/$USER/hias-core/components/agents/mqtt/scripts/run.sh" | sudo tee -a /lib/systemd/system/HIAS-MQTT-IoT-Agent.service
        echo "" | sudo tee -a /lib/systemd/system/HIAS-MQTT-IoT-Agent.service
        ...
        sudo sed -i -- "s/YourUser/$USER/g" /home/$USER/hias-core/components/agents/mqtt/scripts/run.sh
        sudo chmod 744 /home/$USER/hias-core/components/agents/mqtt/scripts/run.sh

        printf -- '\033[32m SUCCESS: HIAS MQTT IoT Agent service installed! \033[0m\n';
